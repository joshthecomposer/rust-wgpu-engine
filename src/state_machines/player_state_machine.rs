...
pub fn player_state_machine(
    ...
    if *health <= 0.0 {
        match controller.state {
            ...
            _ => {
                return player_non_combat_transition(
                    controller,
                    PlayerState::Dying,
                    animator,
                    false,
        ...
        match controller.state {
            ...
            PlayerState::Jumping => {
                ...
                if gs.just_landed && controller.time_in_state >= 0.2 {
                    ...
                    //sm.play_sound_3d(SoundType::Jump, &player_pos, player_id);
                    particles.spawn_oneshot_emitter("DesertLand", player_pos, None);
            ...
            PlayerState::Dashing => {
                ...
                if controller.time_in_state >= 0.05 {
                    ...
                    particles.spawn_oneshot_emitter("DesertSlide", player_pos, None);
                }
